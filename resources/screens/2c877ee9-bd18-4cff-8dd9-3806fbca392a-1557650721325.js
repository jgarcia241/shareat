jQuery("#simulation")
  .on("click", ".s-2c877ee9-bd18-4cff-8dd9-3806fbca392a .click", function(event, data) {
    ...
    if(jFirer.is("#s-Black-cover")) {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-checkbox_9")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-checkbox_10")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-checkbox_11")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/73b23d67-d46f-4ab8-bf96-ca4252cbe3dd"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
